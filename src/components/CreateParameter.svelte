...
<form action="#" method="post" on:submit={insertParameter}>
  <fieldset>
    <legend>Parameter Info</legend>

    <label for="p-name">Parameter Name</label>
    <input type="text" id="p-name" bind:value={parameterName} />

    <label for="p-value">Parameter Value</label>
    <input type="text" id="p-value" bind:value={parameterValue} />
  </fieldset>
